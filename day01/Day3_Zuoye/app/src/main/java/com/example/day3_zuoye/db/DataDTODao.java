...
/** 
 * DAO for table "DATA_DTO".
*/
public class DataDTODao extends AbstractDao<DataDTO, Long> {

    public static final String TABLENAME = "DATA_DTO";

    /**
     * Properties of entity DataDTO.<br/>
    ...
    public DataDTODao(DaoConfig config) {
        super(config);
    }
    
    public DataDTODao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DATA_DTO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DATA_DTO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DataDTO entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DataDTO entity) {
        stmt.clearBindings();
    ...
    @Override
    public DataDTO readEntity(Cursor cursor, int offset) {
        DataDTO entity = new DataDTO( //
    ...
    @Override
    public void readEntity(Cursor cursor, DataDTO entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DataDTO entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DataDTO entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DataDTO entity) {
