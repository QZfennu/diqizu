...
public class SFFragment extends Fragment {
    ...
    public static SFFragment newInstance(String param1, String param2) {
        SFFragment fragment = new SFFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_s_f, container, false);
        initView(inflate);
        return inflate;
    }
    ...
    private void initView(@NonNull final View itemView) {
        ...
        list.add(new TPFragment());
        list.add(new SPFragment());
        list.add(new WBFragment());
