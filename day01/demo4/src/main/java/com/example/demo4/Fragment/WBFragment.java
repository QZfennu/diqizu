 ...
 * Use the {@link WBFragment#newInstance} factory method to
...
public class WBFragment extends Fragment {
     ...
     * @return A new instance of fragment WBFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WBFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_w_b, container, false);
        initView(inflate);
        initData();
        return inflate;
    }
    ...
    private void initView(@NonNull final View itemView) {
        ...
        mRecycler.setAdapter(textAdapter);
