...
public class MoneyAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<MoneyBean.DataBean.TongQianTopBean.ListBean> list;

    public MoneyAdapter(Context context, ArrayList<MoneyBean.DataBean.TongQianTopBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder1.jingyan.setText(list.get(position).getTongQian()+"铜钱");
