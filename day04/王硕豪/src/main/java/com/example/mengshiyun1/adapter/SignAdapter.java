...
public class SignAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<SignBean.DataBean.SignTopBean.ListBean> list;

    public SignAdapter(Context context, ArrayList<SignBean.DataBean.SignTopBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder1.jingyan.setText("连续签到"+list.get(position).getDays()+"天");
